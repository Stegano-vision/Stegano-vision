...
# msg2 = "luenjlub"
# key = "fair"
# m1 = encryption(msg1, key)
# print("encrypted key:", m1)
# m2 = decryption(msg2, key)
# print("decrypted key:", m2)
...
answer={}
# Read image.
img = cv2.imread("C:/Users/glair/Desktop/S7 project/output/1684083540.png", cv2.IMREAD_COLOR)
...
h_msg=''.join([chr(int(i, 2)) for i in chunks_of_8])
print("msg, key from sheet:",h_msg)

l= h_msg.split(" ")
m=l[0]
key=l[1]
hidden_msg=decryption(m,key)
print("hidden msg:",hidden_msg)